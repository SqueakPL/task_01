...
class DefaultContextConfig 
{
     ...
     */
    public function serialization(mixed $value = []): \Symfony\Config\JmsSerializer\InstancesConfig\DefaultContext\SerializationConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function deserialization(mixed $value = []): \Symfony\Config\JmsSerializer\InstancesConfig\DefaultContext\DeserializationConfig|static
    {
        if (!\is_array($value)) {
