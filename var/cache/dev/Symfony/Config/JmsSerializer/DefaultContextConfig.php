...
class DefaultContextConfig 
{
     ...
     */
    public function serialization(mixed $value = []): \Symfony\Config\JmsSerializer\DefaultContext\SerializationConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function deserialization(mixed $value = []): \Symfony\Config\JmsSerializer\DefaultContext\DeserializationConfig|static
    {
        if (!\is_array($value)) {
