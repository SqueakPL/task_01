...
class __TwigTemplate_f748895551272f303a139a6698fb5c5b22d233f95c9b161a2b8ed20799bf6bb0 extends Template
{
    private $source;
    private $macros = [];
            ...
            <tr>
                ...
                foreach ($context['_seq'] as $context["type"] => $context["handlers"]) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["handler"]) {
                        // line 53
                        echo twig_var_dump($this->env, $context, ...[$context["handler"]]);
                        echo "<br>";
                    }
            ...
            <tr>
                ...
                foreach ($context['_seq'] as $context["type"] => $context["calls"]) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
                        ...
                        <td>";
                        // line 85
                        echo twig_var_dump($this->env, $context, ...[twig_get_attribute($this->env, $this->source, $context["call"], "handler", [], "any", false, false, false, 85)]);
                        echo "</td>
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "C:\\Projekty\\Symfony\\task_01\\vendor\\jms\\serializer-bundle\\Resources\\views\\Collector\\handlers.html.twig");
    }
}
